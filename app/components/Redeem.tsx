        ...
        <div className="relative w-full min-h-screen bg-transparent overflow-x-hidden flex justify-center items-start pt-[130px] pb-20">
            ...
            <div className="relative w-full max-w-[472px] z-10 px-4">
                ...
                <div className="relative flex flex-col px-5 sm:px-6 py-6 sm:py-8">
                    ...
                    {/* ── Approve Button ── */}
                    <button className="mt-6 mb-1 w-full h-[58px] bg-[#62d732] border-2 border-[#309c04] rounded-[17px] text-white text-[14px] [font-family:var(--font-poppins)] font-bold leading-[1.02] tracking-[-0.04em] transition-all hover:translate-y-0.5">
                        Approve
                    </button>
                </div>
            </div>
