                ...
                <div className="relative h-[685px] flex flex-col px-5 sm:px-6 py-6 sm:py-8">
                    ...
                    <div className="mt-1 space-y-2 px-1">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="flex flex-col text-[14px] [font-family:var(--font-sigmar)] font-normal text-right leading-[23px] tracking-[2%]">
                                ...
                                <span className="text-black text-[14px]">0.02074854 WETH</span>
                    ...
                    <div className="mt-4 flex items-center justify-between px-1">
                        ...
                        <div className="flex gap-2.5">
                            <button className="w-[62px] h-[34px] bg-[#62d732] border-2 border-[#309c03] rounded-[11px] shadow-[0px_4px_0px_#309c04] text-white text-[14px] font-semibold [font-family:var(--font-poppins)] tracking-[2%] leading-[100%] flex items-center justify-center transition-all hover:scale-105 active:translate-y-1 active:shadow-none">
                                0.5%
                            </button>
                            <button className="w-[62px] h-[34px] bg-transparent border-2 border-[#309c03] rounded-[11px] text-[#309c03] text-[14px] font-semibold [font-family:var(--font-poppins)] tracking-[2%] leading-[100%] flex items-center justify-center transition-all hover:scale-105 active:translate-y-1">
                                0.5%
                            </button>
                            <button className="w-[62px] h-[34px] bg-transparent border-2 border-[#309c03] rounded-[11px] text-[#309c03] text-[14px] font-semibold [font-family:var(--font-poppins)] tracking-[2%] leading-[100%] flex items-center justify-center transition-all hover:scale-105 active:translate-y-1">
                                0.5%
                    ...
                    {/* Approve Button */}
                    <button className="mt-6 w-full h-[58px] bg-[#62d732] border-2 border-[#309c03] rounded-[17px] text-white text-[20px] font-bold [font-family:var(--font-sigmar)] shadow-[0px_4px_0px_#309c04] transition-all hover:translate-y-0.5 active:translate-y-2 active:shadow-none uppercase tracking-wider">
                        Approve
                    </button>
                </div>
            </div>
